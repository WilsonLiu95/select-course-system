export default {
  ...
  routes: [
    ...
    // tab页面
    {
      ...
      children: [
        // 基本的四个
        { path: '', redirect: "tab-course" }, // 重定向到默认的course
        { name: 'tab-course', path: 'tab-course', component: require('_views/tab/course.vue') },
        { name: 'tab-account', path: 'tab-account', component: require('_views/tab/account.vue') },
      ]
    },
    // 其他页面
    ...
    // 公共选修课程 专业方向课程 选课与退选页面
    { name: "handle-course", path: '/course/(direction|common)/(select|quit)', component: require('_views/page/handle-course.vue') },
    // 选课结果
